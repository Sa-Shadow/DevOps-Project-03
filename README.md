...
![Tech Stack](https://img.shields.io/badge/Tech-Linux%20%C2%B7%20Shell%20Scripting%20%C2%B7%20Bash%20%C2%B7%20DevOps%20%C2%B7%20SysAdmin-F59E0B?style=for-the-badge)
...
A **hands-on Linux playground** for Cloud & DevOps engineers — covering essential Linux commands, shell scripting patterns, process management, file systems, networking, and automation tricks used daily in real-world DevOps workflows.

## ✨ Key Highlights

- ✅ Linux file system navigation & permissions mastery
- ✅ Shell scripting: loops, conditions, functions
- ✅ Process management: ps, kill, systemctl, journalctl
- ✅ Crontab scheduling & automation
- ✅ Networking: netstat, ss, curl, wget, iptables basics
- ✅ Log management & grep/awk/sed text processing
- ✅ Package management: apt, yum, dnf

## 🧰 Tech Stack & Tools

`Bash · Zsh · Linux (Ubuntu/CentOS) · Vim · Cron · Systemd · GNU Coreutils · OpenSSH`
